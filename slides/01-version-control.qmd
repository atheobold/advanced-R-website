...
::: {.large}
::: {.callout-important}
You should now have your own copy (fork) of the Lab 1 repository open. 

Follow the [instructions posted on Canvas](https://scribehow.com/viewer/Forking_a_Repository_and_Cloning_into_RStudio__TKGOvrrYQ1GMfYCafxercg) to clone that repository into RStudio.
...
Open the `lab-1.qmd` file from the repository (it should be easily accessible
from your Files tab).

Change the `author: "YOUR NAME HERE"` line to include your name. 

Save the document. 
:::
:::

## Your Turn - Commit that Change

::: {.large}
> I will live code this process!
...
1. Check the box of the document you want to commit changes from (this stages
the changes)
2. Type out a commit message describing the changes you made (make it short!)
3. Click the Commit button to commit these documents with that commit message
:::
