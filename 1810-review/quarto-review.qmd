...
From the dplyr section \## Learning More About Packages in R
...
::: column-margin
{{< video https://www.youtube.com/embed/BV0-EPUYuQc >}} Stop watching at 4:16.
:::
...
#| out-width: "70%"
#| echo: false
knitr::include_graphics("images/working-directory-console.png")
```
...
#| echo: false
#| fig-align: center
knitr::include_graphics("images/create-new-rproj-step1.png")
knitr::include_graphics("images/create-new-rproj-step2.png")
```
...
#| echo: false
#| fig-align: center
knitr::include_graphics("images/create-new-rproj-step3.png")
```
...
#| echo: false
#| fig-align: center
knitr::include_graphics("images/create-existing-rproj-step1.png")
```
...
#| echo: false
#| fig-align: center
knitr::include_graphics("images/create-existing-rproj-step2.png")
```
